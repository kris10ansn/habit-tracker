...
`docs/assets/device-frames/remarkable-folio-front-source.png`: a larger front-facing white tablet
on an angled tan folio. Its 944x708 screen window is exactly 4:3, so the real capture is uniformly
scaled without stretching, cropping, or perspective distortion. Screen text is never generated by AI.
